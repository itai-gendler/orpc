...
const query = useQuery($orpc.marketTrend.list.queryOptions())
...
const refreshMutation = useMutation($orpc.marketTrend.refresh.mutationOptions({
  async onSuccess(result) {
    await queryClient.invalidateQueries({
      queryKey: $orpc.marketTrend.list.key(),
    })
